    ...
    <main>
      <section className="mx-auto max-w-[980px] px-6 py-10">
        <div className="mt-8 rounded bg-sts-sectionB p-8">
          <h2 className={`${playfair.className} text-[1.84rem] md:text-[2.725rem] text-center`}>Designed for Real Life. Completed by You.</h2>
      ...
      <div className="bg-sts-sectionA">
        <section className="mx-auto max-w-[980px] px-6 py-14 text-center">
          <h2 className={`${playfair.className} text-[1.84rem] md:text-[2.725rem]`}> The Founding Edition</h2>
          <p className="mt-2 text-[1.05rem] md:text-[1.525rem] text-black/70">The debut of the JacketBag. <br /> 15 pieces handmade by the founder.</p>
